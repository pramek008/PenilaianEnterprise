...
import com.projectKtpUts.uts_pae.exceptions.NonexistentEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.projectKtpUts_uts_pae_jar_0.0.1-SNAPSHOTPU");
